...
; 将图像放入二进制的多部分/表单数据中，并返回一个SafeArray COM对象。
...
; 将图像转换为文件格式，并返回指向RandomAccessStream的指针。
;   extension  -  File Encoding           |  string   ->   bmp, gif, jpg, png, tiff
;   quality    -  JPEG Quality Level      |  integer  ->   0 - 100
...
; 将图像转换为文件格式并返回一个SafeArray COM对象。
;   extension  -  File Encoding           |  string   ->   bmp, gif, jpg, png, tiff
;   quality    -  JPEG Quality Level      |  integer  ->   0 - 100
